...
class CustomPaginatedDataTable extends StatefulWidget {
  ...
  /// should be provided each time a particular [CustomPaginatedDataTable] widget is
  /// created; avoid creating a new [DataTableSource] with each new instance of
  /// the [CustomPaginatedDataTable] widget unless the data table really is to now
  ...
  // Take dataRowColor from DataTableSource
...
class CustomPaginatedDataTableState extends State<CustomPaginatedDataTable> {
  ...
  void reassemble() {
    ...
    // triggering a notification, leaving the CustomPaginatedDataTable in an invalid
