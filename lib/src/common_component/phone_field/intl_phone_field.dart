  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry = _countryList.firstWhere(
          (item) =>
              item.code == (widget.initialCountryCode ?? 'AU') ||
              item.dialCode == (widget.initialCountryCode ?? '+61') ||
              item.dialCode ==
                  (widget.initialCountryCode?.replaceFirst("+", "") ?? '+61'),
          orElse: () => _countryList.first);
    ...
    return Column(
      ...
      children: [
        widget.title != null
            ...
            : const SizedBox(),
        widget.title != null ? const SizedBox(height: 10.0) : const SizedBox(),
        TextFormField(
