...
class AppColor {
  static const Color primaryColor = Color(0xFF2196F3); // Full opacity
  static Color primary1Color = Colors.blue.withOpacity(0.5); // 50% opacity
  static Color primaryBGColor = Colors.blue.withOpacity(0.15); // 15% opacity
  static const Color primarySecondaryColor = Color(0xFF007BFF);
  static const Color primaryQuizeColor = Color(0xFF3c43d2);

  static const Color streakIconColor = Color(0xFFF6820D);
