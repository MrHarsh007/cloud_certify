...
class AssessmentType extends EnumClass {
  ...
  static const AssessmentType multipleChoice = _$multipleChoice;

  /// Enum for assessment types
  @BuiltValueEnumConst(wireName: r'multi_select', fallback: true)
  static const AssessmentType multiSelect = _$multiSelect;

  static Serializer<AssessmentType> get serializer =>
